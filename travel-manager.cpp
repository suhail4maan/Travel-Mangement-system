...
public:
    ...
    void hotels()
    {
        string hotelNo[] = { "Avendra", "Redission Blue", "Hyatt" };
        for (int a = 0; a < 3; a++)
        {
        ...
        if (choiceHotel == 1) {
            ...
            cout << "-------WELCOME TO HOTEL REDISSION BLUE-------\n" << endl;
            ...
            if (packChoice1 == 1) {
                hotelCost = 15000.00;
                cout << "You have successfully booked Family Pack at Redission Blue" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 2) {
                hotelCost = 10000.00;
                cout << "You have successfully booked Couple Pack at Redission Blue" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else if (packChoice1 == 3) {
                hotelCost = 5000.00;
                cout << "You have successfully booked Single Pack at Redission Blue" << endl;
                cout << "Goto Menu and take the receipt" << endl;
            }
            else {
                cout << "Invalid Input! Redirecting to Previous Menu \nPlease Wait!" << endl;
            ...
            cout << "-------WELCOME TO HOTEL HYATT-------\n" << endl;
            cout << "Set in tropical gardens on the banks of the Maha Oya river While Seeing Hyatt" << endl;
